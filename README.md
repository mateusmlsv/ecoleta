...
Project developed at **[Rocketseat][rocketseat_site]**'s **NextLevelWeek#1** event using TypeScript, Node, React and React Native technologies
...
Application to help people find waste collection points efficiently
...
#### **Node Api** ([NodeJS][node] + [TypeScript][typescript])
...
- **[Visual Studio Code][vscode]** &rarr; Extensions: **<kbd>[SQLite][vscode_sqlite_extension]</kbd>**
- **[Insomnia][insomnia]**
- **[IBGE API][ibge_api]** &rarr; **<kbd>[States and Cities Api][ibge_api_municipios]</kbd>** 
- **[Leaflet][leaflet]**
...
[ibge_api_municipios]: https://servicodados.ibge.gov.br/api/docs/localidades?versao=1#api-_
